	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitPayment.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (name.getText().toString().isEmpty() || card.getText().toString().isEmpty()
						|| date.getText().toString().isEmpty() || cvv.getText().toString().isEmpty()) {
					...
					try {
						...
						Toast.makeText(Payment.this, "You Successfully advertised your course", Toast.LENGTH_LONG)
								.show();
						startActivity(home);
