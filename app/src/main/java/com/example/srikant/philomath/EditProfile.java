...
String              pas = newPass.getText().toString();
                    try {
                        ...
                        if((!editPassword.getText().toString().equals(jsonObject.getString("password")))&&(!pas.isEmpty())){
                            Toast.makeText(EditProfile.this,"Password you entered dosen't match with existing records",Toast.LENGTH_LONG).show();
                        }

                       else if((!newPass.getText().toString().equals(confirmPass.getText().toString()))&& (!pas.isEmpty())){
                            ...
                            try {
                                ...
                                String address = editAddress.getText().toString() + "," + city.getText().toString() + "," + state.getText().toString() + "," + country.getText().toString();
                                if (address.length() < 5) {
                                ...
                                if (conn.getResponseCode() == 200) {
                                    ...
                                    Toast.makeText(EditProfile.this, "Problem in connecting server", Toast.LENGTH_LONG).show();
                    ...
                    if(!course.isEmpty()){
                        ...
                        try {
                            if(c.Category.equals("Select Category")){
                               ...
                               // String message = EmailID + "," + course + "," + c.Category;
