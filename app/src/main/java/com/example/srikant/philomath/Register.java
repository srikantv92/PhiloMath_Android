...
public class Register extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.tutor_categories,
		...
		ArrayAdapter<CharSequence> seq_adapter = ArrayAdapter.createFromResource(this, R.array.security_questions,
				android.R.layout.simple_spinner_item);
		...
		// If Are you a tutor is checked or unchecked. Change the visibility of
		...
		register.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!password.getText().toString().equals(confirmPassword.getText().toString())) {
				...
				} else if (fullName.getText().toString().isEmpty() || password.getText().toString().isEmpty()
					...
					Toast.makeText(Register.this, "Password should contain minimum 6 characters", Toast.LENGTH_LONG)
							.show();
				} else if (!m1.matches()) {
					...
					if (course.getText().toString().isEmpty() || availability.getText().toString().isEmpty()
							|| pricing.getText().toString().isEmpty()) {
						Toast.makeText(Register.this, "Please enter all the fields", Toast.LENGTH_LONG).show();
					} else {
						...
						registration.setAddress(address.getText().toString() + "," + city.getText().toString() + ","
